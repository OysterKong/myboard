<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="https://github.com/OysterKong" class="brand-link">
      <img src="${path}/dist/img/OysterKong.png" alt="Kong's logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">OysterKong's github</span>
    </a>
