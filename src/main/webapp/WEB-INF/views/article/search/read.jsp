  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">게시글 상세보기</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
		      ...
		      <form class="form-horizontal">
		        <div class="row">
		          <div class="form-group col-sm-10">
		            <textarea class="form-control input-sm" id="newReplyText" type="text" placeholder="댓글 입력을 입력하세요."></textarea>
		          </div>
		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            ...
		            <div class="modal-body" data-rno>
		                ...
		                <%--<input type="text" id="reply_text" class="form-control"/>--%>
	...
	$(document).ready(function () {
	    ...
	    function printReplyCount(totalCount) {
	        ...
	        if (totalCount === 0) {
	            ...
	            collapsedBox.find(".btn-card-tool").remove();
	            return;
	        }
	    ...
	    function printReplyPaging(pageMaker, targetArea) {
		    ...
		    for (var i = pageMaker.startPage, len = pageMaker.endPage; i <= len; i++) {
		        var strCalss = pageMaker.standard.page == i ? 'class=active' : '';
